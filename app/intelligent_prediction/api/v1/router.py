...
intelligent_prediction_router.include_router(forecast.router, prefix="/forecast", tags=["PRD预测"])
intelligent_prediction_router.include_router(history.router, prefix="/history", tags=["送货历史"])
